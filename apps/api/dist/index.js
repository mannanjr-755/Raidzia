...
const machinery_routes_1 = __importDefault(require("./routes/machinery.routes"));
...
app.use('/api/machinery', machinery_routes_1.default);
app.use('/api/inspection', inspection_routes_1.default);
